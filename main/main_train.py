...
parser.add_argument(
    "--context_size", type=int, default=2, help="Size of context window"
)
parser.add_argument(
    "--embedding_dim", type=int, default=10, help="Dimension of word embeddings"
)
parser.add_argument(
    "--algo",
    type=str,
...
parser.add_argument(
    ...
    type=str,
    default="mps",
    help="GPU device to use (e.g., 'cpu', 'cuda', 'mps')",
)
...
ngrams, vocab, word_to_ix = process_text(
    train_data, context_size=args.context_size, type=args.algo
)
model, losses = train(
    ngrams=ngrams,
    vocab=vocab,
