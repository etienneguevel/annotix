...
def example_data():
    return {
        ...
        "data_id": 1,
        "smiles": "O=CC1=CNC=2C=CC=CC12",
        "compound_name": "3-Formylindole (level 2)",
        "database_name": "Bacterial_metabolites_database",
        "path_to_data": "/data/frederic/ToBeInserted/Json_DataBase/",
        "json_file": "Bacterial_metabolites_database_molecule000003_PEPMASS-146.0600.json",
        "filename": "/data/frederic/ToBeInserted/Json_DataBase/Bacterial_metabolites_database_molecule000003_PEPMASS-146.0600.json",
        "charge": "1+",
    }
...
def test_spectrum():
    ...
    assert (
        spectrum.metadata["charge"] == 1
    )  # the charge is converted into int in matchms
