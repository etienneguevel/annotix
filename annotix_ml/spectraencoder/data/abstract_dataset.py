...
class CustomLightningDataset(LightningDataset):
    def __init__(self, cfg, datasets, **kwargs):
        ...
        self.eval_batch_size = cfg.valid.batch_size
    ...
    def val_dataloader(self) -> DataLoader:
        ...
        return self.dataloader(
            self.val_dataset, shuffle=True, batch_size=self.eval_batch_size, **kwargs
        )
    ...
    def test_dataloader(self) -> DataLoader:
        ...
        return self.dataloader(
            self.test_dataset, shuffle=False, batch_size=self.eval_batch_size, **kwargs
        )
    ...
    def predict_dataloader(self) -> DataLoader:
        ...
        return self.dataloader(
            self.pred_dataset, shuffle=False, batch_size=self.eval_batch_size, **kwargs
        )
