...
from annotix_ml.spectraencoder.utils import unpack_bits
from annotix_ml.spectraencoder.data.featurizers import PairedFeaturizer
from annotix_ml.spectraencoder.data.objects import Spectra, Mol
...
def get_paired_spectra(
    ...
    **kwargs,
    ...
    """
    # First get labels
    compound_id_file = pd.read_csv(BASE_DIR / labels_file, sep="\t").astype(str)
    ...
    spec_folder = BASE_DIR / spec_folder if spec_folder else None
...
class SpectraMolDataset(Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            featurizer (PairedFeaturizer): _description_
        """
        super().__init__()
    ...
    def get_featurizer(self) -> PairedFeaturizer:
        """get_spectra_list."""
        return self.featurizer

    def set_featurizer(self, featurizer: PairedFeaturizer):
        """get_spectra_list."""
        self.featurizer = featurizer
    ...
    def get_mol_list(self) -> np.ndarray:
        """get_mol_list."""
        return self.mol_arr

    def get_smi_list(self):
...
class SpectraMolMismatchHDFDataset(SpectraMolDataset):
    ...
    def _get_decoys(
        ...
        if self.negative_strategy == "random":
            ...
            out_fps = unpack_bits(out_fps, self.num_bits)
